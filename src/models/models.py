...
class Faculties(Base):
    ...
    id                      = Column(Integer, primary_key=True, index=True)
    name                    = Column(String)
    dean_id                 = Column(Integer, ForeignKey("deans.id"))
    created_at                = Column(DateTime, default=datetime.now(), nullable=False)
    updated_at                = Column(DateTime, default=datetime.now(), nullable=False)
    faculties_students      = relationship("Students", back_populates="students_faculties")
    faculties_deans         = relationship("Deans", back_populates="deans_faculties")
...
class Deans(Base):
    ...
    created_at              = Column(DateTime, default=datetime.now(), nullable=False)
    updated_at              = Column(DateTime, default=datetime.now(), nullable=False)   
    deans_faculties         = relationship("Faculties", back_populates="faculties_deans") 
